...
# 2 bool(): Converts a value to a Boolean.
# 3 callable(): Returns True if the object appears callable (i.e., can be called), False otherwise.
# 4 chr(): Returns a character from the specified Unicode code.
# 5 classmethod(): Returns a class method for a function.
...
print("bin inbuilt funciton in python ")
binary1=bin(10)
print(binary1)
...
print("bool() Converts a vlaue toa Boolean")
